...
pip install mypy-protobuf 2>/dev/null || pip3 install mypy-protobuf 2>/dev/null || echo "Warning: could not install mypy-protobuf, will fall back to protoc --pyi_out"
