...
class CArrowChunkIterator : public CArrowIterator {
 public:
   ...
   * Constructor
   */
  CArrowChunkIterator(PyObject* context, char* arrow_bytes, int64_t arrow_bytes_size,
...
class DictCArrowChunkIterator : public CArrowChunkIterator {
 public:
  DictCArrowChunkIterator(PyObject* context, char* arrow_bytes, int64_t arrow_bytes_size,
                          PyObject* use_numpy);
