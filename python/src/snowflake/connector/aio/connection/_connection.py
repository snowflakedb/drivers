...
class Connection(ConnectionMixin):
    ...
    def _telemetry(self) -> AsyncTelemetryClient | None:
        # Return the live async in-band telemetry client so consumers (e.g. Snowpark)
        # reach /telemetry/send, instead of raising NotImplementedError.
