...
class BinaryDataPtr(_message.Message):
    ...
    value: bytes
    length: int
    def __init__(self, value: _Optional[bytes] = ..., length: _Optional[int] = ...) -> None: ...
...
class QueryBindings(_message.Message):
    ...
    json: BinaryDataPtr
    csv: BinaryDataPtr
    def __init__(self, json: _Optional[_Union[BinaryDataPtr, _Mapping]] = ..., csv: _Optional[_Union[BinaryDataPtr, _Mapping]] = ...) -> None: ...
...
class ConnectionCloseRequest(_message.Message):
    __slots__ = ("conn_handle", "server_session_keep_alive", "enable_auto_detection", "error_strategy", "timeout_seconds")
    CONN_HANDLE_FIELD_NUMBER: _ClassVar[int]
    SERVER_SESSION_KEEP_ALIVE_FIELD_NUMBER: _ClassVar[int]
    ENABLE_AUTO_DETECTION_FIELD_NUMBER: _ClassVar[int]
    ...
    error_strategy: str
    timeout_seconds: int
    def __init__(self, conn_handle: _Optional[_Union[ConnectionHandle, _Mapping]] = ..., server_session_keep_alive: _Optional[bool] = ..., enable_auto_detection: _Optional[bool] = ..., error_strategy: _Optional[str] = ..., timeout_seconds: _Optional[int] = ...) -> None: ...

class ConnectionCloseResponse(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ConnectionIsClosedRequest(_message.Message):
    __slots__ = ("conn_handle",)
    CONN_HANDLE_FIELD_NUMBER: _ClassVar[int]
    conn_handle: ConnectionHandle
    def __init__(self, conn_handle: _Optional[_Union[ConnectionHandle, _Mapping]] = ...) -> None: ...

class ConnectionIsClosedResponse(_message.Message):
    __slots__ = ("is_closed",)
...
class StatementExecuteQueryRequest(_message.Message):
    __slots__ = ("stmt_handle", "bindings")
    STMT_HANDLE_FIELD_NUMBER: _ClassVar[int]
    BINDINGS_FIELD_NUMBER: _ClassVar[int]
    stmt_handle: StatementHandle
    bindings: QueryBindings
    def __init__(self, stmt_handle: _Optional[_Union[StatementHandle, _Mapping]] = ..., bindings: _Optional[_Union[QueryBindings, _Mapping]] = ...) -> None: ...
