...
class TestCursorDescribeInternal:
    ...
    (BD#56), ``_to_result_metadata_v1()`` round-trip, and cursor-state side effects.
    """
    ...
    def test_display_size_and_internal_size_for_varchar(self, cursor):
        """display_size carries char length; internal_size carries byte length (BD#56).

        Also confirms BD#56: the V1 describe() path returns display_size=None while
        ...
        # BD#56: V1 describe() always returns display_size=None.
