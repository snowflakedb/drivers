...
5. Provision secrets: `DRIVER_MIRROR_TOKEN` (internal PAT),
...
- **Internal (snowflake-eng):** `DRIVER_MIRROR_TOKEN` — a PAT with access
...
- `DRIVER_MIRROR_TOKEN` — PAT for `snowflake-eng` access.
