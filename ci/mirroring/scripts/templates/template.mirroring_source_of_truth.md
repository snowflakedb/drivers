...
EXTRA_IMPORT_OVERRIDES="__EXTRA_IMPORT_OVERRIDES_RAW__" \
SLACK_CHANNEL_ID="__SLACK_CHANNEL_ID__" \
SLACK_ONCALL_SUBTEAM_ID="__SLACK_ONCALL_SUBTEAM_ID__" \
...
This repo (`snowflake-eng/__REPO_NAME__`) is the canonical source of the mirror
...
This repo (`snowflake-eng/__REPO_NAME__`) is the internal source of
truth. A Copybara-based mirror keeps `snowflakedb/__MIRROR_REPO_NAME__` in
