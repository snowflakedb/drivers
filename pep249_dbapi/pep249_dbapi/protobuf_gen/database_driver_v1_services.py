...
class DatabaseDriver(ABC):
    ...
    @abstractmethod
    def database_set_option_string(
        self, request: DatabaseSetOptionStringRequest
    ) -> DatabaseSetOptionStringResponse:
        pass

    @abstractmethod
    def database_set_option_bytes(
        self, request: DatabaseSetOptionBytesRequest
    ) -> DatabaseSetOptionBytesResponse:
        pass

    @abstractmethod
    def database_set_option_int(
        self, request: DatabaseSetOptionIntRequest
    ) -> DatabaseSetOptionIntResponse:
        pass

    @abstractmethod
    def database_set_option_double(
        self, request: DatabaseSetOptionDoubleRequest
    ...
    def database_release(
        self, request: DatabaseReleaseRequest
    ...
    @abstractmethod
    def connection_set_option_string(
        self, request: ConnectionSetOptionStringRequest
    ) -> ConnectionSetOptionStringResponse:
        pass

    @abstractmethod
    def connection_set_option_bytes(
        self, request: ConnectionSetOptionBytesRequest
    ) -> ConnectionSetOptionBytesResponse:
        pass

    @abstractmethod
    def connection_set_option_int(
        self, request: ConnectionSetOptionIntRequest
    ) -> ConnectionSetOptionIntResponse:
        pass

    @abstractmethod
    def connection_set_option_double(
        self, request: ConnectionSetOptionDoubleRequest
    ...
    def connection_release(
        self, request: ConnectionReleaseRequest
    ) -> ConnectionReleaseResponse:
        pass

    @abstractmethod
    def connection_get_info(
        self, request: ConnectionGetInfoRequest
    ) -> ConnectionGetInfoResponse:
        pass

    @abstractmethod
    def connection_get_objects(
        self, request: ConnectionGetObjectsRequest
    ) -> ConnectionGetObjectsResponse:
        pass

    @abstractmethod
    def connection_get_table_schema(
        self, request: ConnectionGetTableSchemaRequest
    ) -> ConnectionGetTableSchemaResponse:
        pass

    @abstractmethod
    def connection_get_table_types(
        self, request: ConnectionGetTableTypesRequest
    ) -> ConnectionGetTableTypesResponse:
        pass

    @abstractmethod
    def connection_commit(
        self, request: ConnectionCommitRequest
    ) -> ConnectionCommitResponse:
        pass

    @abstractmethod
    def connection_rollback(
        self, request: ConnectionRollbackRequest
    ...
    def statement_release(
        self, request: StatementReleaseRequest
    ) -> StatementReleaseResponse:
        pass

    @abstractmethod
    def statement_set_sql_query(
        self, request: StatementSetSqlQueryRequest
    ) -> StatementSetSqlQueryResponse:
        pass

    @abstractmethod
    def statement_set_substrait_plan(
        self, request: StatementSetSubstraitPlanRequest
    ) -> StatementSetSubstraitPlanResponse:
        pass

    @abstractmethod
    def statement_prepare(
        self, request: StatementPrepareRequest
    ) -> StatementPrepareResponse:
        pass

    @abstractmethod
    def statement_set_option_string(
        self, request: StatementSetOptionStringRequest
    ) -> StatementSetOptionStringResponse:
        pass

    @abstractmethod
    def statement_set_option_bytes(
        self, request: StatementSetOptionBytesRequest
    ) -> StatementSetOptionBytesResponse:
        pass

    @abstractmethod
    def statement_set_option_int(
        self, request: StatementSetOptionIntRequest
    ) -> StatementSetOptionIntResponse:
        pass

    @abstractmethod
    def statement_set_option_double(
        self, request: StatementSetOptionDoubleRequest
    ) -> StatementSetOptionDoubleResponse:
        pass

    @abstractmethod
    def statement_get_parameter_schema(
        self, request: StatementGetParameterSchemaRequest
    ...
    @abstractmethod
    def statement_bind_stream(
        self, request: StatementBindStreamRequest
    ) -> StatementBindStreamResponse:
        pass

    @abstractmethod
    def statement_execute_query(
        self, request: StatementExecuteQueryRequest
    ) -> StatementExecuteQueryResponse:
        pass

    @abstractmethod
    def statement_execute_partitions(
        self, request: StatementExecutePartitionsRequest
    ) -> StatementExecutePartitionsResponse:
        pass

    @abstractmethod
    def statement_read_partition(
        self, request: StatementReadPartitionRequest
        ...
        try:
            ...
            method_map = {
                ...
                "statement_set_sql_query": (
                    self.statement_set_sql_query,
                    StatementSetSqlQueryRequest,
                ),
                "statement_set_substrait_plan": (
                    self.statement_set_substrait_plan,
...
class DatabaseDriverClient:
    ...
    def database_new(self, request: DatabaseNewRequest) -> DatabaseNewResponse:
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "database_new", request.SerializeToString()
        )
        if code == 0:
    ...
    def database_set_option_string(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "database_set_option_string", request.SerializeToString()
        )
        if code == 0:
    ...
    def database_set_option_bytes(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "database_set_option_bytes", request.SerializeToString()
        )
        if code == 0:
    ...
    def database_set_option_int(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "database_set_option_int", request.SerializeToString()
        )
        if code == 0:
    ...
    def database_set_option_double(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "database_set_option_double", request.SerializeToString()
        )
        if code == 0:
    ...
    def database_init(self, request: DatabaseInitRequest) -> DatabaseInitResponse:
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "database_init", request.SerializeToString()
        )
        if code == 0:
    ...
    def database_release(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "database_release", request.SerializeToString()
        )
        if code == 0:
    ...
    def connection_new(self, request: ConnectionNewRequest) -> ConnectionNewResponse:
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "connection_new", request.SerializeToString()
        )
        if code == 0:
    ...
    def connection_set_option_bytes(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "connection_set_option_bytes", request.SerializeToString()
        )
        if code == 0:
    ...
    def connection_set_option_int(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "connection_set_option_int", request.SerializeToString()
        )
        if code == 0:
    ...
    def connection_init(self, request: ConnectionInitRequest) -> ConnectionInitResponse:
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "connection_init", request.SerializeToString()
        )
        if code == 0:
    ...
    def connection_release(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "connection_release", request.SerializeToString()
        )
        if code == 0:
    ...
    def connection_get_info(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "connection_get_info", request.SerializeToString()
        )
        if code == 0:
    ...
    def connection_get_objects(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "connection_get_objects", request.SerializeToString()
        )
        if code == 0:
    ...
    def connection_get_table_schema(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "connection_get_table_schema", request.SerializeToString()
        )
        if code == 0:
    ...
    def connection_get_table_types(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "connection_get_table_types", request.SerializeToString()
        )
        if code == 0:
    ...
    def connection_commit(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "connection_commit", request.SerializeToString()
        )
        if code == 0:
    ...
    def connection_rollback(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "connection_rollback", request.SerializeToString()
        )
        if code == 0:
    ...
    def statement_new(self, request: StatementNewRequest) -> StatementNewResponse:
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "statement_new", request.SerializeToString()
        )
        if code == 0:
    ...
    def statement_release(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "statement_release", request.SerializeToString()
        )
        if code == 0:
    ...
    def statement_set_sql_query(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "statement_set_sql_query", request.SerializeToString()
        )
        if code == 0:
    ...
    def statement_prepare(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "statement_prepare", request.SerializeToString()
        )
        if code == 0:
    ...
    def statement_set_option_string(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "statement_set_option_string", request.SerializeToString()
        )
        if code == 0:
    ...
    def statement_set_option_bytes(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "statement_set_option_bytes", request.SerializeToString()
        )
        if code == 0:
    ...
    def statement_set_option_int(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "statement_set_option_int", request.SerializeToString()
        )
        if code == 0:
    ...
    def statement_set_option_double(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "statement_set_option_double", request.SerializeToString()
        )
        if code == 0:
    ...
    def statement_bind(self, request: StatementBindRequest) -> StatementBindResponse:
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "statement_bind", request.SerializeToString()
        )
        if code == 0:
    ...
    def statement_bind_stream(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "statement_bind_stream", request.SerializeToString()
        )
        if code == 0:
    ...
    def statement_execute_query(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "statement_execute_query", request.SerializeToString()
        )
        if code == 0:
    ...
    def statement_read_partition(
        ...
        (code, response_bytes) = self._transport.handle_message(
            "DatabaseDriver", "statement_read_partition", request.SerializeToString()
        )
        if code == 0:
