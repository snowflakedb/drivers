...
fn rowtype_to_column_metadata(rt: &RowType) -> ColumnMetadata {
    match rt {
        ...
        RowType::Boolean { name, nullable } => ColumnMetadata {
            name: name.clone(),
        ...
        RowType::Real { name, nullable } => ColumnMetadata {
            name: name.clone(),
        ...
        RowType::Date { name, nullable } => ColumnMetadata {
            name: name.clone(),
        ...
        RowType::TimestampNtz {
            ...
            name: name.clone(),
            r#type: "TIMESTAMP_NTZ".to_string(),
            precision: None,
            scale: Some(*scale as i64),
            length: None,
            byte_length: None,
        ...
        RowType::Object { name, nullable } => ColumnMetadata {
            name: name.clone(),
        ...
        RowType::Array { name, nullable } => ColumnMetadata {
            name: name.clone(),
        ...
        RowType::Map { name, nullable } => ColumnMetadata {
            name: name.clone(),
