...
pub struct ExecuteQueryOutcome {
    ...
    /// UUID v4 generated by the client before the query was submitted.
    /// `None` when the result came from a path that doesn't generate a
    /// client-side request ID (e.g. `connection_get_query_result`).
