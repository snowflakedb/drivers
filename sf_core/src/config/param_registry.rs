...
pub struct ParamDef {
    ...
    pub odbc_alias: Option<&'static str>,
...
pub const ACCOUNT: ParamDef = ParamDef {
    canonical_name: "account",
    aliases: &["ACCOUNT"],
    odbc_alias: Some("ACCOUNT"),
...
pub const HOST: ParamDef = ParamDef {
    canonical_name: "host",
    aliases: &["SERVER", "HOST"],
    odbc_alias: Some("SERVER"),
    value_type: ValueType::String,
...
pub const PORT: ParamDef = ParamDef {
    canonical_name: "port",
    aliases: &["PORT"],
    odbc_alias: Some("PORT"),
...
pub const PROTOCOL: ParamDef = ParamDef {
    canonical_name: "protocol",
    aliases: &["PROTOCOL"],
    odbc_alias: Some("PROTOCOL"),
    value_type: ValueType::String,
    required: Required::Never,
...
pub const SERVER_URL: ParamDef = ParamDef {
...
pub const USER: ParamDef = ParamDef {
    canonical_name: "user",
    aliases: &["UID"],
    odbc_alias: Some("UID"),
    value_type: ValueType::String,
...
pub const PASSWORD: ParamDef = ParamDef {
...
pub const AUTHENTICATOR: ParamDef = ParamDef {
    canonical_name: "authenticator",
    aliases: &["AUTHENTICATOR"],
    odbc_alias: Some("AUTHENTICATOR"),
    value_type: ValueType::String,
    required: Required::Never,
    default: None,
    sensitive: false,
...
pub const PRIVATE_KEY: ParamDef = ParamDef {
    canonical_name: "private_key",
    aliases: &["PRIV_KEY_BASE64"],
    odbc_alias: Some("PRIV_KEY_BASE64"),
    value_type: ValueType::String,
...
pub const PRIVATE_KEY_FILE: ParamDef = ParamDef {
    canonical_name: "private_key_file",
    aliases: &["PRIV_KEY_FILE"],
    odbc_alias: Some("PRIV_KEY_FILE"),
    value_type: ValueType::String,
    required: Required::Never,
    default: None,
    sensitive: false,
...
pub const PRIVATE_KEY_PASSWORD: ParamDef = ParamDef {
    canonical_name: "private_key_password",
    aliases: &["PRIV_KEY_FILE_PWD", "PRIV_KEY_PWD"],
    odbc_alias: Some("PRIV_KEY_FILE_PWD"),
    value_type: ValueType::String,
    required: Required::Never,
    default: None,
    sensitive: true,
...
pub const TOKEN: ParamDef = ParamDef {
    canonical_name: "token",
    aliases: &["TOKEN"],
    odbc_alias: Some("TOKEN"),
    value_type: ValueType::String,
...
pub const DATABASE: ParamDef = ParamDef {
    canonical_name: "database",
    aliases: &["DATABASE"],
    odbc_alias: Some("DATABASE"),
    value_type: ValueType::String,
    required: Required::Never,
    default: None,
    sensitive: false,
...
pub const SCHEMA: ParamDef = ParamDef {
    canonical_name: "schema",
    aliases: &["SCHEMA"],
    odbc_alias: Some("SCHEMA"),
    value_type: ValueType::String,
    required: Required::Never,
    default: None,
    sensitive: false,
...
pub const WAREHOUSE: ParamDef = ParamDef {
    canonical_name: "warehouse",
    aliases: &["WAREHOUSE"],
    odbc_alias: Some("WAREHOUSE"),
    value_type: ValueType::String,
    required: Required::Never,
    default: None,
    sensitive: false,
...
pub const ROLE: ParamDef = ParamDef {
    canonical_name: "role",
    aliases: &["ROLE"],
    odbc_alias: Some("ROLE"),
    value_type: ValueType::String,
    required: Required::Never,
    default: None,
    sensitive: false,
...
pub const CUSTOM_ROOT_STORE_PATH: ParamDef = ParamDef {
    canonical_name: "custom_root_store_path",
    aliases: &["TLS_CUSTOM_ROOT_STORE_PATH"],
    odbc_alias: Some("TLS_CUSTOM_ROOT_STORE_PATH"),
    value_type: ValueType::String,
    required: Required::Never,
    default: None,
    sensitive: false,
...
pub const VERIFY_HOSTNAME: ParamDef = ParamDef {
    canonical_name: "verify_hostname",
    aliases: &["TLS_VERIFY_HOSTNAME"],
    odbc_alias: Some("TLS_VERIFY_HOSTNAME"),
...
pub const VERIFY_CERTIFICATES: ParamDef = ParamDef {
    canonical_name: "verify_certificates",
    aliases: &["TLS_VERIFY_CERTIFICATES"],
    odbc_alias: Some("TLS_VERIFY_CERTIFICATES"),
    value_type: ValueType::Bool,
    required: Required::Never,
    default: Some(|| Setting::Bool(true)),
    sensitive: false,
...
pub const CRL_CHECK_MODE: ParamDef = ParamDef {
    canonical_name: "crl_check_mode",
    aliases: &["CRL_MODE", "CRL_ENABLED"],
    odbc_alias: Some("CRL_MODE"),
    value_type: ValueType::String,
    required: Required::Never,
...
pub const CRL_ENABLE_DISK_CACHING: ParamDef = ParamDef {
...
pub const CRL_ENABLE_MEMORY_CACHING: ParamDef = ParamDef {
...
pub const CRL_CACHE_DIR: ParamDef = ParamDef {
...
pub const CRL_VALIDITY_TIME: ParamDef = ParamDef {
...
pub const CRL_ALLOW_CERTIFICATES_WITHOUT_CRL_URL: ParamDef = ParamDef {
...
pub const CRL_HTTP_TIMEOUT: ParamDef = ParamDef {
...
pub const CRL_CONNECTION_TIMEOUT: ParamDef = ParamDef {
...
pub const CONNECTION_NAME: ParamDef = ParamDef {
