...
impl TryFrom<&RowType> for query_types::RowType {
    ...
    fn try_from(value: &RowType) -> Result<Self, Self::Error> {
        ...
        match effective_type.to_uppercase().as_str() {
            ...
            "FILE" => Ok(query_types::RowType::file(&name, nullable)),
...
mod tests {
    ...
    #[test]
    fn test_file_type_maps_to_file() {
        let row_type = RowType {
            name: "file_col".to_string(),
        ...
        assert!(matches!(
            converted,
            crate::query_types::RowType::File {
                ref name,
                nullable: true,
            } if name == "file_col"
        ));
