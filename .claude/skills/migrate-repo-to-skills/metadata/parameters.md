...
there exists an environment variable `MIGRATE_REPO_TO_SKILLS_SF_LOCATION`,
and to do this make sure to use the command
`printenv MIGRATE_REPO_TO_SKILLS_SF_LOCATION`.
