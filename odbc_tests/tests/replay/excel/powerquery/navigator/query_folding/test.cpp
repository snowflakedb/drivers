...
TEST_CASE("Replay: excel powerquery navigator query_folding", "[excel][powerquery][navigator][long_running]") {
  ...
  // SQLAllocHandle - SQLHDBC
  {
    SQLRETURN ret = SQLAllocHandle(SQL_HANDLE_DBC, env2, &dbc3);
    REQUIRE_THAT(OdbcResult(ret, SQL_HANDLE_ENV, env2), OdbcMatchers::IsSuccess());
  ...
  // SQLAllocHandle - SQLHDBC
  {
    SQLRETURN ret = SQLAllocHandle(SQL_HANDLE_DBC, env2, &dbc4);
    REQUIRE_THAT(OdbcResult(ret, SQL_HANDLE_ENV, env2), OdbcMatchers::IsSuccess());
  ...
  // SQLAllocHandle - SQLHDBC
  {
    SQLRETURN ret = SQLAllocHandle(SQL_HANDLE_DBC, env2, &dbc5);
    REQUIRE_THAT(OdbcResult(ret, SQL_HANDLE_ENV, env2), OdbcMatchers::IsSuccess());
  ...
  // SQLAllocHandle - SQLHDBC
  {
    SQLRETURN ret = SQLAllocHandle(SQL_HANDLE_DBC, env2, &dbc6);
    REQUIRE_THAT(OdbcResult(ret, SQL_HANDLE_ENV, env2), OdbcMatchers::IsSuccess());
  ...
  // SQLAllocHandle - SQLHDBC
  {
    SQLRETURN ret = SQLAllocHandle(SQL_HANDLE_DBC, env2, &dbc7);
    REQUIRE_THAT(OdbcResult(ret, SQL_HANDLE_ENV, env2), OdbcMatchers::IsSuccess());
  ...
  // SQLAllocHandle - SQLHDBC
  {
    SQLRETURN ret = SQLAllocHandle(SQL_HANDLE_DBC, env2, &dbc8);
    REQUIRE_THAT(OdbcResult(ret, SQL_HANDLE_ENV, env2), OdbcMatchers::IsSuccess());
  ...
  // SQLAllocHandle - SQLHDBC
  {
    SQLRETURN ret = SQLAllocHandle(SQL_HANDLE_DBC, env2, &dbc9);
    REQUIRE_THAT(OdbcResult(ret, SQL_HANDLE_ENV, env2), OdbcMatchers::IsSuccess());
  ...
  // SQLAllocHandle - SQLHDBC
  {
    SQLRETURN ret = SQLAllocHandle(SQL_HANDLE_DBC, env2, &dbc10);
    REQUIRE_THAT(OdbcResult(ret, SQL_HANDLE_ENV, env2), OdbcMatchers::IsSuccess());
  ...
  // SQLAllocHandle - SQLHSTMT
  {
    SQLRETURN ret = SQLAllocHandle(SQL_HANDLE_STMT, dbc10, &stmt7);
  ...
  // SQLBindParameter 1 (manual: DATEVAL > 2024-01-01; the WinODBC trace records
  // only the buffer pointer, so the bound value is recovered from the Excel ODBC
  // trace plan — Power Query's folded "After 2024-01-01" filter,
  // Table.SelectRows(..., each [DATEVAL] > #date(2024,1,1))).
  SQL_DATE_STRUCT param_val_0 = {};
  param_val_0.year = 2024;
  param_val_0.month = 1;
  param_val_0.day = 1;
  SQLLEN param_ind_0 = sizeof(param_val_0);
  {
    SQLRETURN ret = SQLBindParameter(stmt7, 1, SQL_PARAM_INPUT, SQL_C_TYPE_DATE, SQL_TYPE_DATE, 10, 0, &param_val_0,
                                     sizeof(param_val_0), &param_ind_0);
  ...
  // SQLExecDirect
  {
    SQLRETURN ret = SQLExecDirect(
        ...
        sqlchar(
            "select \"ROWKIND\",\r\n    \"INTVAL\",\r\n    \"NUM18S6\",\r\n    \"VARCHARVAL\",\r\n    \"BOOLVAL\",\r\n "
            "   \"DATEVAL\"\r\nfrom \"ODBCMETADATATESTDB\".\"DATATYPETESTS\".\"ALLDATATYPESNAV\"\r\nwhere \"DATEVAL\" "
            "> ?\r\norder by \"VARCHARVAL\""),
        SQL_NTS);
  ...
  // SQLGetData col 5
  {
    SQLLEN ind = 0;
    std::vector<char> buf(2048, static_cast<char>(0xFF));
    SQLRETURN ret = SQLGetData(stmt7, 5, SQL_C_BIT, buf.data(), 2048, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt7), OdbcMatchers::IsSuccess());
    CHECK(ind == 1);
  ...
  // SQLGetData col 6
  {
    SQLLEN ind = 0;
    std::vector<char> buf(2048, static_cast<char>(0xFF));
    SQLRETURN ret = SQLGetData(stmt7, 6, SQL_C_TYPE_DATE, buf.data(), 2048, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt7), OdbcMatchers::IsSuccess());
    CHECK(ind == 6);
  ...
  SQLHDBC dbc11 = SQL_NULL_HDBC;
  // SQLAllocHandle - SQLHDBC
  {
    SQLRETURN ret = SQLAllocHandle(SQL_HANDLE_DBC, env2, &dbc11);
    REQUIRE_THAT(OdbcResult(ret, SQL_HANDLE_ENV, env2), OdbcMatchers::IsSuccess());
    REQUIRE(dbc11 != SQL_NULL_HDBC);
  }

  // SQLSetConnectAttr - SQL_ATTR_LOGIN_TIMEOUT
  {
    SQLRETURN ret = SQLSetConnectAttr(dbc11, SQL_ATTR_LOGIN_TIMEOUT, (SQLPOINTER)15, -5);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_DBC, dbc11), OdbcMatchers::IsSuccess());
  }

  // SQLDriverConnect
  {
    SQLRETURN ret = SQLDriverConnect(dbc11, nullptr, sqlchar(config.connection_string().c_str()), SQL_NTS, nullptr, 0,
                                     nullptr, SQL_DRIVER_NOPROMPT);
    REQUIRE_THAT(OdbcResult(ret, SQL_HANDLE_DBC, dbc11), OdbcMatchers::Succeeded());
  }
  ...
  // SQLGetInfo - SQL_DRIVER_NAME
  {
    char buf[256] = {};
    SQLSMALLINT len = 0;
    SQLRETURN ret = SQLGetInfo(dbc11, SQL_DRIVER_NAME, buf, 255, &len);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_DBC, dbc11), OdbcMatchers::IsSuccess());
  }
  ...
  // SQLGetInfo - SQL_DRIVER_VER
  {
    char buf[256] = {};
    SQLSMALLINT len = 0;
    SQLRETURN ret = SQLGetInfo(dbc11, SQL_DRIVER_VER, buf, 255, &len);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_DBC, dbc11), OdbcMatchers::IsSuccess());
  }
  ...
  // SQLGetInfo - SQL_DBMS_NAME
  {
    char buf[256] = {};
    SQLSMALLINT len = 0;
    SQLRETURN ret = SQLGetInfo(dbc11, SQL_DBMS_NAME, buf, 255, &len);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_DBC, dbc11), OdbcMatchers::IsSuccess());
  }
  ...
  // SQLGetInfo - SQL_DBMS_VER
  {
    char buf[256] = {};
    SQLSMALLINT len = 0;
    SQLRETURN ret = SQLGetInfo(dbc11, SQL_DBMS_VER, buf, 255, &len);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_DBC, dbc11), OdbcMatchers::IsSuccess());
  }
  ...
  // SQLAllocHandle - SQLHSTMT
  {
    SQLRETURN ret = SQLAllocHandle(SQL_HANDLE_STMT, dbc11, &stmt8);
    REQUIRE_THAT(OdbcResult(ret, SQL_HANDLE_DBC, dbc11), OdbcMatchers::IsSuccess());
  ...
  // SQLGetInfo - SQL_DRIVER_ODBC_VER
  {
    char buf[256] = {};
    SQLSMALLINT len = 0;
    SQLRETURN ret = SQLGetInfo(dbc11, SQL_DRIVER_ODBC_VER, buf, 255, &len);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_DBC, dbc11), OdbcMatchers::IsSuccess());
  }
  ...
  // SQLBindParameter 1 (manual: DATEVAL > 2024-01-01; same folded filter value
  // from the Excel ODBC trace plan, re-bound for the second refresh of the query).
  SQL_DATE_STRUCT param_val_1 = {};
  param_val_1.year = 2024;
  param_val_1.month = 1;
  param_val_1.day = 1;
  SQLLEN param_ind_1 = sizeof(param_val_1);
  {
    SQLRETURN ret = SQLBindParameter(stmt8, 1, SQL_PARAM_INPUT, SQL_C_TYPE_DATE, SQL_TYPE_DATE, 10, 0, &param_val_1,
                                     sizeof(param_val_1), &param_ind_1);
  ...
  // SQLGetInfo - SQL_GETDATA_EXTENSIONS
  {
    char buf[256] = {};
    SQLSMALLINT len = 0;
    SQLRETURN ret = SQLGetInfo(dbc11, SQL_GETDATA_EXTENSIONS, buf, 255, &len);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_DBC, dbc11), OdbcMatchers::IsSuccess());
    SQLUINTEGER numericValue = 0;
    std::memcpy(&numericValue, buf, sizeof(numericValue));
    CHECK(numericValue == 0xBu);
  ...
  // SQLGetData col 5
  {
    SQLLEN ind = 0;
    std::vector<char> buf(2048, static_cast<char>(0xFF));
    SQLRETURN ret = SQLGetData(stmt8, 5, SQL_C_BIT, buf.data(), 2048, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt8), OdbcMatchers::IsSuccess());
    CHECK(ind == 1);
    CHECK((static_cast<SQLCHAR>(buf[0]) != 0) == true);
  }
  ...
  // SQLGetData col 6
  {
    SQLLEN ind = 0;
    std::vector<char> buf(2048, static_cast<char>(0xFF));
    SQLRETURN ret = SQLGetData(stmt8, 6, SQL_C_TYPE_DATE, buf.data(), 2048, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt8), OdbcMatchers::IsSuccess());
    CHECK(ind == 6);
    const SQL_DATE_STRUCT* _ds = reinterpret_cast<SQL_DATE_STRUCT*>(buf.data());
    CHECK(_ds->year == 2024);
  ...
  // SQLDisconnect
  {
    SQLRETURN ret = SQLDisconnect(dbc11);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_DBC, dbc11), OdbcMatchers::Succeeded());
  }

  // SQLFreeHandle - SQLHDBC
  {
    SQLRETURN ret = SQLFreeHandle(SQL_HANDLE_DBC, dbc11);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_DBC, dbc11), OdbcMatchers::IsSuccess());
  }
  ...
  // skipped 95 SQLColAttribute call(s) with undocumented field id
}
