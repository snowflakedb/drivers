...
TEST_CASE("Replay: exec_direct_getdata_13col_2rows", "[dtm]") {
  ...
  // SQLExecDirect
  {
    SQLRETURN ret = SQLExecDirect(stmt0, sqlchar("desc table \"DTMREPLAYTESTDB\".\"PUBLIC\".\"hq18673_t\""), SQL_NTS);
