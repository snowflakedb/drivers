...
TEST_CASE("Replay: exec_direct_getdata_13col_50rows", "[dtm]") {
  ...
  // SQLExecDirect
  {
    SQLRETURN ret = SQLExecDirect(stmt0, sqlchar("desc table \"DTMREPLAYTESTDB\".\"PUBLIC\".\"prr_table_1\""), SQL_NTS);
  ...
  // SQLGetData col 1
  {
    ...
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_9");
    CHECK(ind == 5);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_11");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_13");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_15");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_17");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_43");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_32");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_18");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 2
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 2, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "VARCHAR(11)");
    CHECK(ind == 11);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_1");
    CHECK(ind == 5);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_20");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_7");
    CHECK(ind == 5);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_38");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 2
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 2, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "VARCHAR(9)");
    CHECK(ind == 10);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_41");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_22");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_27");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_21");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_45");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 2
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 2, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "NUMBER(30,6)");
    CHECK(ind == 12);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_33");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_48");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_26");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_23");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_34");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_35");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_37");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_8");
    CHECK(ind == 5);
  }
  ...
  // SQLGetData col 2
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 2, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "VARCHAR(31)");
    CHECK(ind == 11);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_3");
    CHECK(ind == 5);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_30");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_19");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_44");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_29");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_5");
    CHECK(ind == 5);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_40");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_2");
    CHECK(ind == 5);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_28");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_36");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_31");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_25");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_4");
    CHECK(ind == 5);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_47");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_6");
    CHECK(ind == 5);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_39");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "col_46");
    CHECK(ind == 6);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "audit_col_2");
    CHECK(ind == 11);
  }
  ...
  // SQLGetData col 2
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 2, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "VARCHAR(17)");
    CHECK(ind == 11);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "audit_col_1");
    CHECK(ind == 11);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "audit_col_4");
    CHECK(ind == 11);
  }
  ...
  // SQLGetData col 2
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 2, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "TIME(0)");
    CHECK(ind == 7);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "audit_col_6");
    CHECK(ind == 11);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "audit_col_5");
    CHECK(ind == 11);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "audit_col_8");
    CHECK(ind == 11);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "audit_col_3");
    CHECK(ind == 11);
  }
  ...
  // SQLGetData col 1
  {
    ...
    SQLRETURN ret = SQLGetData(stmt0, 1, SQL_CHAR, buf.data(), 4096, &ind);
    CHECK_THAT(OdbcResult(ret, SQL_HANDLE_STMT, stmt0), OdbcMatchers::IsSuccess());
    CHECK(std::string(buf.data()) == "audit_col_7");
    CHECK(ind == 11);
  }
