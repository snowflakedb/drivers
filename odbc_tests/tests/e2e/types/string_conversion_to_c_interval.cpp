...
// Interval") and writes a SQL_INTERVAL_STRUCT. The spec enumerates four
// outcomes:
//
...
//
// Every test case below maps to one of these outcomes. The old driver does
// not implement this conversion at all (it rejects every SQL_C_INTERVAL_*
// target with SQLSTATE 07006), so every TEST_CASE is gated on the new
// driver via SKIP_OLD_DRIVER("BD#54", ...).
...
namespace {
constexpr const char* kBD = "BD#54";
constexpr const char* kBDMessage =
    "VARCHAR -> SQL_C_INTERVAL_* fetch is new in the universal driver; "
    "the old driver rejects every interval target with SQLSTATE 07006";
}  // namespace

// ============================================================================
// Outcome #1 - Valid value, no truncation (SQL_SUCCESS).
// ============================================================================
...
TEST_CASE_METHOD(ConnSchemaFixture, "should fetch VARCHAR as single-field SQL_C_INTERVAL_*",
  ...
  SKIP_OLD_DRIVER(kBD, kBDMessage);
...
// ============================================================================
// Outcome #2 - Valid value, trailing-field truncation (SQL_SUCCESS_WITH_INFO,
// SQLSTATE 01S07).
// ============================================================================
...
// ============================================================================
// Outcome #3 - Leading-field precision lost (SQL_ERROR, SQLSTATE 22015).
//
...
// ============================================================================
// Outcome #4 - Not a valid interval value (SQL_ERROR, SQLSTATE 22018).
// ============================================================================
