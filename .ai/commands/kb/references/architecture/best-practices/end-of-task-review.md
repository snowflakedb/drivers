---
description: The self-review criteria applied before a Universal Driver change is called done — commit-scope drift, loose test assertions, refactor-stale comments, error-string changes needing a callout, self-sabotaging fixtures, dead-code helpers, and signature smells.
no-pointer: true
---
