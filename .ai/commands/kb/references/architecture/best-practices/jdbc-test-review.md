---
description: What makes a JDBC/Java Universal Driver test correct and non-flaky — the quality criteria a review applies, and the flakiness patterns to reject.
no-pointer: true
---
