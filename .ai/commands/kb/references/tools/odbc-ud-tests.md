---
description: Building and running ODBC Universal Driver tests — the Rust driver build, the C++ harness, run.sh and ctest, DRIVER_PATH, unixodbc/iodbc setup, and run_reference.sh comparison runs.
no-pointer: true
---
