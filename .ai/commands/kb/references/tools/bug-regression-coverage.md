---
description: Establishing whether the Universal Driver has regression coverage for a Jira bug (SNOW-XXXXXX) — the sources to read for a ticket, and how to judge a candidate test as covering it.
no-pointer: true
---
...
run via that wrapper's own procedure — see the per-wrapper references catalogued
in [README.md](README.md). This proves whether the UD has the regression *right
now*, and is the primary output.
...
- **Python** → [python-ud-tests.md](python-ud-tests.md)
- **ODBC** → [odbc-ud-tests.md](odbc-ud-tests.md)
- **JDBC** → [jdbc-ud-tests.md](jdbc-ud-tests.md)
- **Node.js** → [nodejs-ud-tests.md](nodejs-ud-tests.md)
...
- **Python** → [python-ud-tests.md](python-ud-tests.md) (`hatch run dev:unit -k test_regression_snow_XXXXXX`)
- **ODBC** → [odbc-ud-tests.md](odbc-ud-tests.md) (`./odbc_tests/run.sh -R "snow_XXXXXX"`)
- **JDBC** → [jdbc-ud-tests.md](jdbc-ud-tests.md) (`./gradlew test --tests "RegressionSnowXXXXXXTest"`)
- **Node.js** → [nodejs-ud-tests.md](nodejs-ud-tests.md) (`cd nodejs && npm run build:core && npm run test:e2e -- regression-snow-XXXXXX`)
...
- **UD credentials and core build**: See Step 0 and the wrapper runbook
  references catalogued in [README.md](README.md). `parameters.json`
...
- **Python UD requires compiled Rust core even for unit tests**: The driver
  ...
  [python-ud-tests.md](python-ud-tests.md).
