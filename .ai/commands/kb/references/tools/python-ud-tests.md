---
description: Building and running Python Universal Driver tests — compiling sf_core, the hatch environment, unit/integ/e2e runs, SKIP_CORE_BUILD, maturin develop, and the "Couldn't load core driver dependency" / "libsf_core not found" failures.
no-pointer: true
---
