 ...
 *
 * <p><b>Note:</b> Copied from snowflake-jdbc
 */
public final class SnowflakeTypeHelper {
   ...
   * @return int representation of type from {@link Types}
   */
   ...
   *
   * @param type the Java SQL type from {@link Types}
  ...
  public enum JavaSQLType {
     ...
     *
     * @param type the integer type from {@link Types}
