...
public class NumberTest : Snowflake.Data.Tests.NumberTest, IReferenceTest
{
    public NumberTest(ReferenceITFixture fixture, ITestOutputHelper output) : base(fixture, output)
    {
        Fixture = fixture;
    }
