...
Feature: Numeric Types Support
  ...
  @python
  Scenario: should cast FLOAT and its synonyms to appropriate type and preserve values when selecting from table
    Given Snowflake client is logged in
  ...
  @python
  Scenario: should handle extreme values of FLOAT correctly
    Given Snowflake client is logged in
