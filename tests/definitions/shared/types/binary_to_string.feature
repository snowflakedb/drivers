...
Feature: String representation of binary data
  ...
  # ODBC converts BINARY to SQL_C_CHAR as uppercase HEX only. There is no
  # statement-level BINARY_OUTPUT_FORMAT, matching the 3.x driver.
  @nodejs_e2e @odbc_not_needed
