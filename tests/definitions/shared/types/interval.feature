@odbc @python @jdbc @nodejs @core_not_needed
Feature: INTERVAL datatype handling
  ...
  # TODO: Too many tests. This file should be split in 2:
  # - interval_day_time
  # - interval_year_month
  ...
  @odbc_e2e @python_e2e @jdbc_e2e @nodejs_not_needed
  Scenario: should cast INTERVAL values to appropriate type for YEAR TO MONTH and DAY TO SECOND
    ...
    # Node: cells are the internal integer as a string — total months for YEAR TO MONTH,
    #       total nanoseconds for DAY TO SECOND. Covered by other scenarios.
